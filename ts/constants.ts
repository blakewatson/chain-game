...
export const COLOR_SUCCESS_GRADIENT_TOP = '#38ff38';
export const COLOR_SUCCESS_GRADIENT_BOTTOM = '#139a13';
export const COLOR_SUCCESS_TEXT = '#073807';
...
export const TILE_H = 65 + SHADOW_Y;
